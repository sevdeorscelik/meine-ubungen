...
// list full names with city
// Andrew Fuller (Tacoma)
// employees.forEach(emp => {
// 	console.log(`${emp.firstName} ${emp.lastName} (${emp.address.city})`);
// });

// list full names with city (with map())
// Andrew Fuller (Tacoma)
//  const empNames = employees.map(emp => `${emp.firstName} ${emp.lastName} (${emp.address.city})`);
// console.log(empNames);
//  empNames.forEach(emp => console.log(emp));

// string of cities in the UK
// e.g. "London, Manchester, Devon"
